...
FPSAMPLE_BUILD_DIR="${TOTALSEGMENTATOR_WRAPPER_MAC_FPSAMPLE_BUILD_DIR:-${ROOT}/build/fpsample-wheel}"
ACVL_UTILS_BUILD_DIR="${TOTALSEGMENTATOR_WRAPPER_MAC_ACVL_UTILS_BUILD_DIR:-${ROOT}/build/acvl-utils-wheel}"
...
run_component_command() {
  ...
  TOTALSEGMENTATOR_WRAPPER_MAC_FPSAMPLE_BUILD_DIR="${FPSAMPLE_BUILD_DIR}" \
  TOTALSEGMENTATOR_WRAPPER_MAC_ACVL_UTILS_BUILD_DIR="${ACVL_UTILS_BUILD_DIR}" \
