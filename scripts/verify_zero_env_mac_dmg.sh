...
DMG_PATH="${1:-${ROOT}/dist/TotalSegmentator Wrapper for Mac-0.2.1-20260728-surface-preview-arm64.dmg}"
EXPECTED_APP_VERSION="${TOTALSEGMENTATOR_WRAPPER_MAC_EXPECTED_APP_VERSION:-0.2.1}"
