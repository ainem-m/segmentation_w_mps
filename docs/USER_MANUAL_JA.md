...
準備中に必要なデータを取得することがあります。通信環境によっては時間がかかります。
...
ファイルを選んだ場合は、NIfTI形式のCTとして取り込みます。フォルダを選んだ場合は、DICOMの撮影フォルダとして内容を確認します。
...
DICOMフォルダを選ぶと、アプリは撮影データの構成を確認し、3D作成用のCTを準備します。
