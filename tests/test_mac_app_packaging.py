...
class MacAppPackagingTests(unittest.TestCase):
    ...
    def test_notarization_script_submits_staples_and_validates_dmg(self) -> None:
        ...
        self.assertIn('APP_VERSION="${TOTALSEGMENTATOR_WRAPPER_MAC_APP_VERSION:-0.3.0}"', text)
        self.assertIn('DMG_VERSION_TAG="${TOTALSEGMENTATOR_WRAPPER_MAC_DMG_VERSION_TAG:-${APP_VERSION}-20260729-final}"', text)
    ...
    def test_dmg_scripts_support_user_local_install_validation(self) -> None:
        ...
        self.assertIn("0.3.0", verify_text)
        self.assertIn("0.3.0-20260729-final-arm64.dmg", verify_text)
